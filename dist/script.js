...
const translations = {
  en: {
    ...
    "about.card.fullstack.desc":
      "End-to-end web application development using ASP.NET Core, Entity Framework, and REST APIs, with focus on structured architecture and maintainable code.",
    "about.card.frontend.title": "Frontend Development with Angular",
    "about.card.frontend.desc":
      "Building responsive and dynamic user interfaces using Angular, TypeScript, and modern CSS, with focus on usability and clean component architecture.",
    "about.card.database.title": "Database Design & Data Modeling",
    "about.card.database.desc":
      "Designing relational databases with SQL Server and PostgreSQL, including schema design, queries, and efficient data structures for scalable applications.",
    "about.card.security.title": "Backend & API Development",
    "about.card.security.desc":
      "Developing RESTful APIs with ASP.NET Core, handling business logic, data flow, and integration with external services.",
    ...
    "education.skills.item1": "Clean Architecture",
    "education.skills.item2": "REST API Development (ASP.NET Core)",
    "education.skills.item3": "Entity Framework & Database Design",
    "education.skills.item4": "Component-based UI (Angular)",
    "education.skills.item5": "Responsive & Accessible UI",
    ...
    "education.entries.0.description":
      ".NET system development vocational program with AI focus (EduGrade). Focused on backend development, API design, database systems, and modern web application architecture.",
  ...
  sv: {
    ...
    "about.card.fullstack.title": "Fullstackutveckling i .NET",
    "about.card.fullstack.desc":
      "End-to-end-utveckling av webbapplikationer med ASP.NET Core, Entity Framework och REST API:er, med fokus på strukturerad arkitektur och underhållbar kod.",
    "about.card.frontend.title": "Frontendutveckling med Angular",
    "about.card.frontend.desc":
      "Bygger responsiva och dynamiska användargränssnitt med Angular, TypeScript och modern CSS, med fokus på användbarhet och ren komponentarkitektur.",
    "about.card.database.title": "Databasdesign och datamodellering",
    "about.card.database.desc":
      "Design av relationsdatabaser med SQL Server och PostgreSQL, inklusive schemadesign, frågor och effektiva datastrukturer för skalbara applikationer.",
    "about.card.security.title": "Backend- och API-utveckling",
    "about.card.security.desc":
      "Utveckling av RESTful API:er med ASP.NET Core, med hantering av affärslogik, dataflöden och integrationer med externa tjänster.",
    ...
    "education.skills.item1": "Clean Architecture",
    "education.skills.item2": "REST API utveckling (ASP.NET Core)",
    "education.skills.item3": "Entity Framework & Databasdesign",
    "education.skills.item4": "Komponentbaserad UI (Angular)",
    "education.skills.item5": "Responsivt och tillgängligt UI",
    ...
    "education.entries.0.description":
      "YH-program i systemutveckling .NET med AI-inriktning (EduGrade). Fokus på backendutveckling, API design, databaser och moderna webbapplikationer.",
